export function generateSudoku(grid: number[][], level: number) {
...
export function getSolvedSudoku(): number[][] {
    // return solved array
    return createSolvedArray();
}

function createSolvedArray(): number[][] {
